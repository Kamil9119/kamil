#==========SC SEND > PROGRAMMER ALEX
#====== TELIGERM TEAM : https://t.me/+9llqPQbiQ1hiN2Vl
...
def menu():
	...
	banner()
	print("")
	print(" [ 1 ] File Cloing luffy ")
	print("")
	SALE = input(' HALBZHERA = ')
	if SALE in ['1','01']:
		FILE()
		exit()
def FILE():
			...
			try:
				print('')
				print('')
				print('        \033[1;37mINPUT FILE luffy          ')
				print('')
				...
				exit(" \033[1;37mFILE HALAYA bra[!]"%(fileX))
def setting():
	os.system('clear')
	banner()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \033[1;31m[\033[1;31mLUFFY]   {P}{H}{loop} \033[1;34m{P}{P}{H}=\033[1;34m {ok}\033[1;34m{P} \033[1;34m "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;37m [ luffy-CP ]\033[1;37m  {idf}\033[1;37m |\033[1;37m {pw}')
				...
				print(f'\r\033[1;34m [ luffy-OK ]\033[1;34m  {idf} \033[1;34m| \033[1;34m{pw}')
