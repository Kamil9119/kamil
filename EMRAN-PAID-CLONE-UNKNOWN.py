...
{gradient[4]}╠══════════════════════════════════════════════════╣
{gradient[0]}║ {gradient[1]}Author   : 𝙋𝙍𝙊𝙂𝙍𝘼𝙈𝙈𝙀𝙍 𝘼𝙇𝙀𝙓             {gradient[2]}║
{gradient[1]}║ {gradient[2]}Version  : 2025 𝙑𝙄𝙋 𝙀𝘿𝙄𝙏𝙄𝙊𝙉               {gradient[3]}║
{gradient[2]}║ {gradient[3]}Team     : 𝙐𝙉𝙆𝙉𝙊𝙒𝙉 𝘾𝙔𝘽𝙀𝙍 𝙏𝙀𝘼𝙈                 {gradient[4]}║
{gradient[3]}║ {gradient[4]}Github   :  𝙉𝙊𝙏-𝘼𝙑𝘼𝙄𝙇𝘼𝘽𝙇𝙀            {gradient[0]}║
